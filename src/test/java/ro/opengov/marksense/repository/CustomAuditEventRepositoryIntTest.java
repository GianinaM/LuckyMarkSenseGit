...
import ro.opengov.marksense.config.audit.AuditEventConverter;
import ro.opengov.marksense.domain.PersistentAuditEvent;
...
import static ro.opengov.marksense.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
